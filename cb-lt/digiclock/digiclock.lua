--[[TEXT WIDGET v1.3 by ghunt 27/10/2014
...
function conky_draw_text()
	...
	local col0,col1,col2=0x00FF00,0x5EFF00,0x0081FF
	local colbg=0xFF5900
    text_settings={
